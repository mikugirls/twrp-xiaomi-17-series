...
# nezha combined_v43: exclude the HBTP virtual input device so TWRP does not
# mistake it for the real touch input node (matches the EkinStrop/JohnTheFarm3r
# reference tree, which relies on kernel-module-only touch with no touch_report).
